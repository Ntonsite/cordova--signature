...
public class InAppBrowser extends CordovaPlugin {
    ...
    class C00735 implements Runnable {

        /* renamed from: org.apache.cordova.inappbrowser.InAppBrowser$5$1 */
        class C00721 extends WebViewClient {
            C00721() {
            }
        ...
        public void run() {
            ...
            if (childView != null) {
                childView.setWebViewClient(new C00721());
    ...
    public boolean execute(String action, CordovaArgs args, CallbackContext callbackContext) throws JSONException {
        if (action.equals("open")) {
            ...
            this.cordova.getActivity().runOnUiThread(new C00692());
            ...
            this.cordova.getActivity().runOnUiThread(new C00703());
            pluginResult = new PluginResult(Status.OK);
            pluginResult.setKeepCallback(true);
            this.callbackContext.sendPluginResult(pluginResult);
        }
    ...
    private void injectDeferredObject(String source, String jsWrapper) {
        ...
        LOG.m0d(LOG_TAG, "Can't inject code into the system browser");
    }
    ...
    public void closeDialog() {
        this.cordova.getActivity().runOnUiThread(new C00735());
    }
    ...
    public String showWebPage(final String url, HashMap<String, Boolean> features) {
        ...
        this.cordova.getActivity().runOnUiThread(new Runnable() {
            ...
            class C00763 implements OnKeyListener {
                C00763() {
                }
            ...
            public void run() {
                ...
                back.setOnClickListener(new C00741());
                ...
                linearLayout.setOnClickListener(new C00752());
                ...
                InAppBrowser.this.edittext.setOnKeyListener(new C00763());
                ...
                close.setOnClickListener(new C00774());
                ...
                InAppBrowser.this.inAppWebView.setWebChromeClient(new InAppChromeClient(thatWebView) {
                    public boolean onShowFileChooser(WebView webView, ValueCallback<Uri[]> filePathCallback, FileChooserParams fileChooserParams) {
                        LOG.m0d(InAppBrowser.LOG_TAG, "File Chooser 5.0+");
                    ...
                    public void openFileChooser(ValueCallback<Uri> uploadMsg, String acceptType, String capture) {
                        LOG.m0d(InAppBrowser.LOG_TAG, "File Chooser 4.1+");
                        openFileChooser(uploadMsg, acceptType);
                    }

                    public void openFileChooser(ValueCallback<Uri> uploadMsg, String acceptType) {
                        LOG.m0d(InAppBrowser.LOG_TAG, "File Chooser 3.0+");
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent intent) {
        if (VERSION.SDK_INT >= 21) {
            LOG.m0d(LOG_TAG, "onActivityResult (For Android >= 5.0)");
