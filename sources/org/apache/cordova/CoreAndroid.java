...
class CoreAndroid extends CordovaPlugin {
    ...
    class C00435 extends BroadcastReceiver {
        C00435() {
        }
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        ...
        try {
            if (action.equals("clearCache")) {
                ...
                this.cordova.getActivity().runOnUiThread(new C00391());
    ...
    public void clearCache() {
        this.cordova.getActivity().runOnUiThread(new C00402());
    }
    ...
    public void clearHistory() {
        this.cordova.getActivity().runOnUiThread(new C00413());
    }

    public void backHistory() {
        this.cordova.getActivity().runOnUiThread(new C00424());
    }
    ...
    private void initTelephonyReceiver() {
        ...
        this.telephonyReceiver = new C00435();
